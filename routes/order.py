...
from controllers.order import get_all_orders, add_new_order, update_order, delete_order, add_item, delete_item
...
order_bp.route('/item', methods=['DELETE'])(delete_item)
